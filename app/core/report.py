...
def highlight_artifacts(text_original, text_precision):
    ...
    filler_phrases = [["comments","could","not","be","loaded"],["loading","comments"],["please","refresh","the","page"],["for","more","information" "visit"],["caption:"],["read","more","of","our","stories"],["subscribe", "now"], ["subscribe", "here"], ["sign", "up"], ["mailing", "list"], ["more", "stories", "like", "this"], ["upgrade", "to", "premium"], ["donate", "to", "support"], 
